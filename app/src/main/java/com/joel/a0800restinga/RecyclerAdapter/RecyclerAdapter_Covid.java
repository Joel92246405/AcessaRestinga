...
public class RecyclerAdapter_Covid extends RecyclerView.Adapter<RecyclerAdapter_Covid.ViewHolder>{
    ...
    private List<String> Titulo, Descricao, Data;

    private LayoutInflater mInflater;
    private ItemClickListener mClickListener;

    // data is passed into the constructor
    public RecyclerAdapter_Covid(Context context, List<String> titulo, List<String> descricao, List<String> data) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        TextView data, titulo, descricao;
