package com.joel.a0800restinga.ui.cadastros.eualugo;
...
public class CadastroEuAlugoFragment extends Fragment implements AdapterView.OnItemSelectedListener, RecyclerAdapter_EuAlugo.ItemClickListener, View.OnClickListener {
    ...
    public static CadastroEuAlugoFragment newInstance() {
        return new CadastroEuAlugoFragment();
    }
